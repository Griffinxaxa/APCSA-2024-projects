...
public class Circle
{
    ...
    /**
     * Create a new circle by passing diameter, xPosition, yPosition, color parameters.
     */
     ...
     * @param distance the distance to move the circle 
     * along the y axis,positive is down
     */
